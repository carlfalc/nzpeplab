...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium research peptides shipped fast across New Zealand. HPLC-verified ≥98% purity, batch COAs, secure payments." },
      { property: "og:title", content: "NZ Peptide Lab" },
      { property: "og:description", content: "HPLC-verified research peptides, shipped fast across NZ." },
